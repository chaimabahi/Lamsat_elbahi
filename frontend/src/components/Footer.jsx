    ...
    <footer className="footer">
        ...
        <div className="footer__grid">
          ...
          <div className="footer__col footer__col--brand">
            ...
            <p className="footer__tagline">
              L'art de la poterie tunisienne, transmise avec passion. Chaque pièce est unique et façonnée à la main.
            </p>
            <div className="footer__socials">
              ...
              <a href="https://wa.me/21650509129" target="_blank" rel="noreferrer" className="footer__social footer__social--whatsapp" aria-label="WhatsApp">
          ...
          <div className="footer__col">
            ...
            <ul>
              ...
              <li><Link to="/products?category=plates">Assiettes</Link></li>
          ...
          <div className="footer__col">
            ...
            <ul className="footer__contact-list">
              <li>+216 97 159 838</li>
              <li>lamsatelbahi@gmail.com</li>
              <li>Nabeul, Tunisie</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="footer__bottom">
        <div className="container footer__bottom-inner">
          <p>© {currentYear} Lamsat Elbahi. Tous droits réservés.</p>
