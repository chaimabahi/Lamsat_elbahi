      ...
      <section className="section brand">
        <div className="container brand__inner">
          <div className="brand__image-wrap">
            <img
              src="https://images.unsplash.com/photo-1604699590803-f31e7e16a5e1?w=700&q=80"
          ...
          <div className="brand__text">
            ...
            <p>
              Lamsat Elbahi — signifiant "la touche belle" — a été fondée par notre grand-mère en 1985 au cœur de Nabeul, en Tunisie. Ce qui a commencé comme un petit atelier est devenu une marque familiale chérie, où chaque pièce est toujours façonnée et peinte à la main.
            </p>
